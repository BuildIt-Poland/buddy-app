...
import Query from './resоlvers/query';
import Mutation from './resоlvers/mutation';
import Buddy from './resоlvers/buddy';
import Newbie from './resоlvers/newbie';
import BuddyTask from './resоlvers/buddy-task';
import NewbieTask from './resоlvers/newbie-task';
import User from './resоlvers/user';
import Task from './resоlvers/task';
