...
export const sampleNewbie = {
  name: 'John Rambo',
  email: 'jrambo@wipro.com',
  password: 'test1234',
  position: 'Front End Engineer',
  photo: 'https://i.pravatar.cc/150?img=3',
  phoneNumber: '+48 642 913 551',
  startDate: '2019-05-02T11:55:33.488Z',
...
export const sampleBuddy = {
  ...
  phoneNumber: '+48 721 588 392',
  startDate: '2019-10-01T09:36:21.488Z',
  allowPushedNotifications: false,
};
