export const getForgotPasswordTemplate = (name: string, link: string) => ({
  ...
  html: `
    <div align='center' style='padding: 2rem;font-size: 15px;'>
      ...
      <h3>Hi ${name},</h3>
      <p style='margin: 2rem 0 0;'>You requested to reset your Buddy App password. For security reasons the link can only be active for one hour.</p>
      <p style='margin: 0 0 2rem;'>Click the button below to complete the process.</p>
