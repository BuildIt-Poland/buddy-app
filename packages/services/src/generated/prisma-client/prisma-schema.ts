...
export const typeDefs = /* GraphQL */ `type AggregateBuddy {
  count: Int!
}
...
type Mutation {
  ...
  updateBuddyTask(data: BuddyTaskUpdateInput!, where: BuddyTaskWhereUniqueInput!): BuddyTask
  updateManyBuddyTasks(data: BuddyTaskUpdateManyMutationInput!, where: BuddyTaskWhereInput): BatchPayload!
  upsertBuddyTask(where: BuddyTaskWhereUniqueInput!, create: BuddyTaskCreateInput!, update: BuddyTaskUpdateInput!): BuddyTask!
  ...
  updateManyNewbies(data: NewbieUpdateManyMutationInput!, where: NewbieWhereInput): BatchPayload!
  upsertNewbie(where: NewbieWhereUniqueInput!, create: NewbieCreateInput!, update: NewbieUpdateInput!): Newbie!
  ...
  updateNewbieTask(data: NewbieTaskUpdateInput!, where: NewbieTaskWhereUniqueInput!): NewbieTask
  updateManyNewbieTasks(data: NewbieTaskUpdateManyMutationInput!, where: NewbieTaskWhereInput): BatchPayload!
...
type Query {
  ...
  buddyTasks(where: BuddyTaskWhereInput, orderBy: BuddyTaskOrderByInput, skip: Int, after: String, before: String, first: Int, last: Int): [BuddyTask]!
  buddyTasksConnection(where: BuddyTaskWhereInput, orderBy: BuddyTaskOrderByInput, skip: Int, after: String, before: String, first: Int, last: Int): BuddyTaskConnection!
  newbie(where: NewbieWhereUniqueInput!): Newbie
  newbies(where: NewbieWhereInput, orderBy: NewbieOrderByInput, skip: Int, after: String, before: String, first: Int, last: Int): [Newbie]!
  newbiesConnection(where: NewbieWhereInput, orderBy: NewbieOrderByInput, skip: Int, after: String, before: String, first: Int, last: Int): NewbieConnection!
